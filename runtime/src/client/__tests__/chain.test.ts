...
describe("chain", () => {
  ...
  test("convert deep scalar query with args", () => {
    ...
    c.path.to({ id: "ID" }).scalar({ id: "ID" }).get();
  ...
  test("convert deep scalar query with args and default value", () => {
    ...
    c.path.to({ id: "ID" }).scalar({ id: "ID" }).get(1, "defaultValue");
  ...
  test("convert deep object query with args", () => {
    ...
    c.path.to({ id: "ID" }).object({ id: "ID" }).get({ some: 1, other: 1 });
  ...
  test("convert deep object query with args and default value", () => {
    ...
    c.path.to({ id: "ID" }).object({ id: "ID" }).get({ some: 1, other: 1 }, "defaultValue");
