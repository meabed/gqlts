...
- Publish through the same direct npm-token model as `web-help-ai-elements`, without npm provenance or fallback recovery branches.
- Document the new conventional-commit release flow for contributors and the docs site.
