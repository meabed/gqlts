...
test("unionType", () =>
  typeRenderTestCase(__dirname, "unionType", <TypeRenderer>unionType, ["Union", "UnionD", "UnionMD"]));

test("inputObjectType", () =>
  typeRenderTestCase(__dirname, "inputObjectType", <TypeRenderer>inputObjectType, [
    "InputF",
    "Input",
    "InputD",
    "InputMD",
