...
export interface message_bool_exp {
  _and?: message_bool_exp[] | null;
  _not?: message_bool_exp | null;
  _or?: message_bool_exp[] | null;
...
export interface message_inc_input {
  id?: Scalars['Int'] | null;
}
...
export interface mutation_rootRequest {
  ...
  delete_message?: [
    ...
    message_mutation_responseRequest,
  ];
  /** delete single row from the table: "message" */
  ...
  delete_user_online?: [
    ...
    user_online_mutation_responseRequest,
  ];
  /** delete data from the table: "user_typing" */
  delete_user_typing?: [
    {
    ...
    user_typing_mutation_responseRequest,
  ];
  /** insert data into the table: "message" */
  insert_message?: [
    {
    ...
    | [
        {
          ...
          /** filter the rows returned */
          where?: user_online_bool_exp | null;
        },
        user_onlineRequest,
      ]
    | user_onlineRequest;
    ...
    | [
        {
          ...
          /** filter the rows returned */
          where?: user_typing_bool_exp | null;
        },
        user_typingRequest,
      ]
    | user_typingRequest;
...
export interface user_bool_exp {
  ...
  last_typed?: timestamptz_comparison_exp | null;
  username?: String_comparison_exp | null;
}
...
export interface user_insert_input {
  id?: Scalars['Int'] | null;
  last_seen?: Scalars['timestamptz'] | null;
  last_typed?: Scalars['timestamptz'] | null;
  username?: Scalars['String'] | null;
}
...
export interface user_online_bool_exp {
  _and?: user_online_bool_exp[] | null;
  _not?: user_online_bool_exp | null;
  _or?: user_online_bool_exp[] | null;
  id?: Int_comparison_exp | null;
  last_seen?: timestamptz_comparison_exp | null;
  last_typed?: timestamptz_comparison_exp | null;
  username?: String_comparison_exp | null;
...
export interface user_online_inc_input {
  id?: Scalars['Int'] | null;
}
...
/** Initial value of the column from where the streaming should start */
export interface user_online_stream_cursor_value_input {
  id?: Scalars['Int'] | null;
  last_seen?: Scalars['timestamptz'] | null;
  last_typed?: Scalars['timestamptz'] | null;
  username?: Scalars['String'] | null;
...
export interface user_typing_bool_exp {
  _and?: user_typing_bool_exp[] | null;
  _not?: user_typing_bool_exp | null;
  _or?: user_typing_bool_exp[] | null;
  id?: Int_comparison_exp | null;
  last_seen?: timestamptz_comparison_exp | null;
  last_typed?: timestamptz_comparison_exp | null;
  username?: String_comparison_exp | null;
...
export interface user_typing_inc_input {
  id?: Scalars['Int'] | null;
}
...
/** Initial value of the column from where the streaming should start */
export interface user_typing_stream_cursor_value_input {
  id?: Scalars['Int'] | null;
  last_seen?: Scalars['timestamptz'] | null;
  last_typed?: Scalars['timestamptz'] | null;
  username?: Scalars['String'] | null;
...
export const isuser_online_aggregate_fields = (
  obj?: { __typename?: any } | null,
): obj is user_online_aggregate_fields => {
...
export const isuser_online_mutation_response = (
  obj?: { __typename?: any } | null,
): obj is user_online_mutation_response => {
...
export const isuser_online_stddev_pop_fields = (
  obj?: { __typename?: any } | null,
): obj is user_online_stddev_pop_fields => {
...
export const isuser_online_stddev_samp_fields = (
  obj?: { __typename?: any } | null,
): obj is user_online_stddev_samp_fields => {
...
export const isuser_online_var_samp_fields = (
  obj?: { __typename?: any } | null,
): obj is user_online_var_samp_fields => {
...
export const isuser_online_variance_fields = (
  obj?: { __typename?: any } | null,
): obj is user_online_variance_fields => {
...
export const isuser_typing_aggregate_fields = (
  obj?: { __typename?: any } | null,
): obj is user_typing_aggregate_fields => {
...
export const isuser_typing_mutation_response = (
  obj?: { __typename?: any } | null,
): obj is user_typing_mutation_response => {
...
export const isuser_typing_stddev_pop_fields = (
  obj?: { __typename?: any } | null,
): obj is user_typing_stddev_pop_fields => {
...
export const isuser_typing_stddev_samp_fields = (
  obj?: { __typename?: any } | null,
): obj is user_typing_stddev_samp_fields => {
...
export const isuser_typing_var_samp_fields = (
  obj?: { __typename?: any } | null,
): obj is user_typing_var_samp_fields => {
...
export const isuser_typing_variance_fields = (
  obj?: { __typename?: any } | null,
): obj is user_typing_variance_fields => {
