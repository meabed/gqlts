export default {
  scalars: [0, 2, 3, 5, 7, 9, 18, 36, 47, 51, 53, 58, 75, 85, 89, 91, 97, 106, 110, 112, 118, 126, 130],
  types: {
    Boolean: {},
    ...
    online_users_aggregate_fields: {
      ...
      count: [
        3,
        {
          columns: [18, '[online_users_select_column!]'],
          distinct: [0],
        },
      ],
      max: [15],
    ...
    option_aggregate_fields: {
      count: [
        3,
        {
          columns: [47, '[option_select_column!]'],
          distinct: [0],
        },
      ],
      max: [38],
    ...
    poll: {
      ...
      options: [
        28,
        {
          distinct_on: [47, '[option_select_column!]'],
          limit: [3],
          offset: [3],
          order_by: [45, '[option_order_by!]'],
          where: [35],
        },
      ],
      options_aggregate: [
    ...
    poll_results_aggregate_fields: {
      ...
      count: [
        3,
        {
          columns: [75, '[poll_results_select_column!]'],
          distinct: [0],
        },
      ],
      max: [72],
    ...
    user_aggregate_fields: {
      count: [
        3,
        {
          columns: [106, '[user_select_column!]'],
          distinct: [0],
        },
      ],
      max: [99],
    ...
    vote_aggregate_fields: {
      count: [
        3,
        {
          columns: [126, '[vote_select_column!]'],
          distinct: [0],
        },
      ],
      max: [120],
    ...
    Query: {
      online_users: [
        10,
        {
          distinct_on: [18, '[online_users_select_column!]'],
          limit: [3],
          offset: [3],
          order_by: [17, '[online_users_order_by!]'],
          where: [14],
        },
      ],
      online_users_aggregate: [
      ...
      poll: [
        54,
        {
          distinct_on: [85, '[poll_select_column!]'],
          limit: [3],
          offset: [3],
          order_by: [65, '[poll_order_by!]'],
          where: [57],
        },
      ],
      poll_aggregate: [
      ...
      poll_results: [
        67,
        {
          distinct_on: [75, '[poll_results_select_column!]'],
          limit: [3],
          offset: [3],
          order_by: [74, '[poll_results_order_by!]'],
          where: [71],
        },
      ],
      poll_results_aggregate: [
      ...
      user: [
        93,
        {
          distinct_on: [106, '[user_select_column!]'],
          limit: [3],
          offset: [3],
          order_by: [104, '[user_order_by!]'],
          where: [96],
        },
      ],
      user_aggregate: [
      ...
      vote: [
        114,
        {
          distinct_on: [126, '[vote_select_column!]'],
          limit: [3],
          offset: [3],
          order_by: [124, '[vote_order_by!]'],
          where: [117],
        },
      ],
      vote_aggregate: [
    ...
    Mutation: {
      ...
      insert_option: [
        42,
        {
          objects: [37, '[option_insert_input!]!'],
          on_conflict: [44],
        },
      ],
      insert_option_one: [
      ...
      update_option_by_pk: [
        ...
        {
          _set: [48],
          pk_columns: [46, 'option_pk_columns_input!'],
        },
      ],
      update_option_many: [
        42,
        {
          updates: [52, '[option_updates!]!'],
        },
      ],
      update_poll: [
        62,
      ...
      update_poll_by_pk: [
        ...
        {
          _set: [86],
          pk_columns: [66, 'poll_pk_columns_input!'],
        },
      ],
      update_poll_many: [
        62,
        {
          updates: [90, '[poll_updates!]!'],
        },
      ],
      update_user: [
        101,
      ...
      update_user_by_pk: [
        ...
        {
          _set: [107],
          pk_columns: [105, 'user_pk_columns_input!'],
        },
      ],
      update_user_many: [
        101,
        {
          updates: [111, '[user_updates!]!'],
        },
      ],
      update_vote: [
        122,
      ...
      update_vote_by_pk: [
        ...
        {
          _set: [127],
          pk_columns: [125, 'vote_pk_columns_input!'],
        },
      ],
      update_vote_many: [
        122,
        {
          updates: [131, '[vote_updates!]!'],
        },
      ],
      __typename: [5],
    },
    Subscription: {
      ...
      online_users_stream: [
        ...
        {
          batch_size: [3, 'Int!'],
          cursor: [22, '[online_users_stream_cursor_input]!'],
          where: [14],
        },
      ],
      option: [
      ...
      option_stream: [
        ...
        {
          batch_size: [3, 'Int!'],
          cursor: [49, '[option_stream_cursor_input]!'],
          where: [35],
        },
      ],
      poll: [
      ...
      poll_results_stream: [
        ...
        {
          batch_size: [3, 'Int!'],
          cursor: [79, '[poll_results_stream_cursor_input]!'],
          where: [71],
        },
      ],
      poll_stream: [
        ...
        {
          batch_size: [3, 'Int!'],
          cursor: [87, '[poll_stream_cursor_input]!'],
          where: [57],
        },
      ],
      user: [
      ...
      user_stream: [
        ...
        {
          batch_size: [3, 'Int!'],
          cursor: [108, '[user_stream_cursor_input]!'],
          where: [96],
        },
      ],
      vote: [
      ...
      vote_stream: [
        ...
        {
          batch_size: [3, 'Int!'],
          cursor: [128, '[vote_stream_cursor_input]!'],
          where: [117],
        },
      ],
      __typename: [5],
