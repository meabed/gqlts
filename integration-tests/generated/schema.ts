...
export type GenericError = (ClientErrorNameAlreadyTaken | ClientErrorNameInvalid | ClientErrorWithoutInterface) & {
  __isUnion?: true;
};
...
export interface QueryPromiseChain {
  ...
  repository: (args: {
    ...
    get: <R extends RepositoryRequest>(
      request: R,
      defaultValue?: FieldsSelection<Repository, R>
  ...
  someScalarValue: ((args?: { x?: Scalars["Float"] | null }) => {
    get: (
  ...
  recursiveType: ((args?: { requiredVal?: Scalars["String"][] | null }) => {
    get: <R extends RecursiveTypeRequest>(
      request: R,
      defaultValue?: (FieldsSelection<RecursiveType, R> | undefined)[] | undefined
    ) => Promise<(FieldsSelection<RecursiveType, R> | undefined)[] | undefined>;
  }) & {
    get: <R extends RecursiveTypeRequest>(
      request: R,
      defaultValue?: (FieldsSelection<RecursiveType, R> | undefined)[] | undefined
  ...
  coordinates: PointPromiseChain & {
    get: <R extends PointRequest>(
      request: R,
      defaultValue?: FieldsSelection<Point, R> | undefined
    ) => Promise<FieldsSelection<Point, R> | undefined>;
  };
  unionThatImplementsInterface: ((args?: { typename?: Scalars["String"] | null }) => {
    get: <R extends GenericErrorRequest>(
      request: R,
      defaultValue?: FieldsSelection<GenericError, R> | undefined
    ) => Promise<FieldsSelection<GenericError, R> | undefined>;
  }) & {
    get: <R extends GenericErrorRequest>(
      request: R,
      defaultValue?: FieldsSelection<GenericError, R> | undefined
  ...
  InterfaceNotImplemented: InterfaceNotImplementedPromiseChain & {
    get: <R extends InterfaceNotImplementedRequest>(
      request: R,
      defaultValue?: FieldsSelection<InterfaceNotImplemented, R> | undefined
    ) => Promise<FieldsSelection<InterfaceNotImplemented, R> | undefined>;
  };
}
...
export interface QueryObservableChain {
  ...
  repository: (args: {
    ...
    get: <R extends RepositoryRequest>(
      request: R,
      defaultValue?: FieldsSelection<Repository, R>
    ) => Observable<FieldsSelection<Repository, R>>;
  };
  ...
  recursiveType: ((args?: { requiredVal?: Scalars["String"][] | null }) => {
    get: <R extends RecursiveTypeRequest>(
      request: R,
      defaultValue?: (FieldsSelection<RecursiveType, R> | undefined)[] | undefined
    ) => Observable<(FieldsSelection<RecursiveType, R> | undefined)[] | undefined>;
  }) & {
    get: <R extends RecursiveTypeRequest>(
      request: R,
      defaultValue?: (FieldsSelection<RecursiveType, R> | undefined)[] | undefined
  ...
  coordinates: PointObservableChain & {
    get: <R extends PointRequest>(
      request: R,
      defaultValue?: FieldsSelection<Point, R> | undefined
    ) => Observable<FieldsSelection<Point, R> | undefined>;
  };
  unionThatImplementsInterface: ((args?: { typename?: Scalars["String"] | null }) => {
    get: <R extends GenericErrorRequest>(
      request: R,
      defaultValue?: FieldsSelection<GenericError, R> | undefined
    ) => Observable<FieldsSelection<GenericError, R> | undefined>;
  }) & {
    get: <R extends GenericErrorRequest>(
      request: R,
      defaultValue?: FieldsSelection<GenericError, R> | undefined
  ...
  InterfaceNotImplemented: InterfaceNotImplementedObservableChain & {
    get: <R extends InterfaceNotImplementedRequest>(
      request: R,
      defaultValue?: FieldsSelection<InterfaceNotImplemented, R> | undefined
    ) => Observable<FieldsSelection<InterfaceNotImplemented, R> | undefined>;
  };
}
...
export interface RecursiveTypePromiseChain {
  ...
  recurse: RecursiveTypePromiseChain & {
    get: <R extends RecursiveTypeRequest>(
      request: R,
      defaultValue?: FieldsSelection<RecursiveType, R> | undefined
    ) => Promise<FieldsSelection<RecursiveType, R> | undefined>;
  };
}
...
export interface RecursiveTypeObservableChain {
  ...
  recurse: RecursiveTypeObservableChain & {
    get: <R extends RecursiveTypeRequest>(
      request: R,
      defaultValue?: FieldsSelection<RecursiveType, R> | undefined
    ) => Observable<FieldsSelection<RecursiveType, R> | undefined>;
  };
}
...
export interface RepositoryPromiseChain {
  ...
  forks: ForkConnectionPromiseChain & {
    get: <R extends ForkConnectionRequest>(
      request: R,
      defaultValue?: FieldsSelection<ForkConnection, R> | undefined
    ) => Promise<FieldsSelection<ForkConnection, R> | undefined>;
  };
}
...
export interface RepositoryObservableChain {
  ...
  forks: ForkConnectionObservableChain & {
    get: <R extends ForkConnectionRequest>(
      request: R,
      defaultValue?: FieldsSelection<ForkConnection, R> | undefined
    ) => Observable<FieldsSelection<ForkConnection, R> | undefined>;
  };
}

export interface ForkConnectionPromiseChain {
  edges: {
    get: <R extends ForkEdgeRequest>(
      request: R,
      defaultValue?: (FieldsSelection<ForkEdge, R> | undefined)[] | undefined
    ) => Promise<(FieldsSelection<ForkEdge, R> | undefined)[] | undefined>;
  };
}
...
export interface ForkConnectionObservableChain {
  edges: {
    get: <R extends ForkEdgeRequest>(
      request: R,
      defaultValue?: (FieldsSelection<ForkEdge, R> | undefined)[] | undefined
    ) => Observable<(FieldsSelection<ForkEdge, R> | undefined)[] | undefined>;
  };
}
...
export interface ForkEdgePromiseChain {
  ...
  node: ForkPromiseChain & {
    get: <R extends ForkRequest>(
      request: R,
      defaultValue?: FieldsSelection<Fork, R> | undefined
    ) => Promise<FieldsSelection<Fork, R> | undefined>;
  };
}
...
export interface ForkEdgeObservableChain {
  ...
  node: ForkObservableChain & {
    get: <R extends ForkRequest>(
      request: R,
      defaultValue?: FieldsSelection<Fork, R> | undefined
    ) => Observable<FieldsSelection<Fork, R> | undefined>;
  };
}
...
export interface InterfaceNotImplementedObservableChain {
  ...
  entry_id: {
    get: (
      request?: boolean | number,
      defaultValue?: Scalars["ID"] | undefined
    ) => Observable<Scalars["ID"] | undefined>;
  };
}
