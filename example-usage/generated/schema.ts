...
export interface StringQueryOperatorInput {
  ...
  regex?: Scalars["String"] | null;
  glob?: Scalars["String"] | null;
}
...
export interface CountryPromiseChain {
  ...
  continent: ContinentPromiseChain & {
    get: <R extends ContinentRequest>(
      request: R,
      defaultValue?: FieldsSelection<Continent, R>
    ) => Promise<FieldsSelection<Continent, R>>;
  };
  capital: {
    get: (
  ...
  languages: {
    get: <R extends LanguageRequest>(
      request: R,
      defaultValue?: FieldsSelection<Language, R>[]
    ) => Promise<FieldsSelection<Language, R>[]>;
  };
  ...
  states: {
    get: <R extends StateRequest>(
      request: R,
      defaultValue?: FieldsSelection<State, R>[]
    ) => Promise<FieldsSelection<State, R>[]>;
  };
}
...
export interface CountryObservableChain {
  ...
  continent: ContinentObservableChain & {
    get: <R extends ContinentRequest>(
      request: R,
      defaultValue?: FieldsSelection<Continent, R>
    ) => Observable<FieldsSelection<Continent, R>>;
  };
  capital: {
    get: (
      request?: boolean | number,
  ...
  languages: {
    get: <R extends LanguageRequest>(
      request: R,
      defaultValue?: FieldsSelection<Language, R>[]
    ) => Observable<FieldsSelection<Language, R>[]>;
  };
  ...
  states: {
    get: <R extends StateRequest>(
      request: R,
      defaultValue?: FieldsSelection<State, R>[]
    ) => Observable<FieldsSelection<State, R>[]>;
  };
}
...
export interface ContinentPromiseChain {
  ...
  countries: {
    get: <R extends CountryRequest>(
      request: R,
      defaultValue?: FieldsSelection<Country, R>[]
    ) => Promise<FieldsSelection<Country, R>[]>;
  };
}
...
export interface ContinentObservableChain {
  ...
  countries: {
    get: <R extends CountryRequest>(
      request: R,
      defaultValue?: FieldsSelection<Country, R>[]
    ) => Observable<FieldsSelection<Country, R>[]>;
  };
}
...
export interface QueryPromiseChain {
  _entities: (args: { representations: Scalars["_Any"][] }) => {
    get: <R extends _EntityRequest>(
      request: R,
      defaultValue?: (FieldsSelection<_Entity, R> | undefined)[]
    ) => Promise<(FieldsSelection<_Entity, R> | undefined)[]>;
  };
  _service: _ServicePromiseChain & {
    get: <R extends _ServiceRequest>(
      request: R,
      defaultValue?: FieldsSelection<_Service, R>
    ) => Promise<FieldsSelection<_Service, R>>;
  };
  countries: ((args?: { filter?: CountryFilterInput | null }) => {
    get: <R extends CountryRequest>(
      request: R,
      defaultValue?: FieldsSelection<Country, R>[]
    ) => Promise<FieldsSelection<Country, R>[]>;
  ...
  country: (args: {
    ...
    get: <R extends CountryRequest>(
      request: R,
      defaultValue?: FieldsSelection<Country, R> | undefined
    ) => Promise<FieldsSelection<Country, R> | undefined>;
  };
  continents: ((args?: { filter?: ContinentFilterInput | null }) => {
    get: <R extends ContinentRequest>(
      request: R,
      defaultValue?: FieldsSelection<Continent, R>[]
    ) => Promise<FieldsSelection<Continent, R>[]>;
  ...
  continent: (args: {
    ...
    get: <R extends ContinentRequest>(
      request: R,
      defaultValue?: FieldsSelection<Continent, R> | undefined
    ) => Promise<FieldsSelection<Continent, R> | undefined>;
  };
  languages: ((args?: { filter?: LanguageFilterInput | null }) => {
    get: <R extends LanguageRequest>(
      request: R,
      defaultValue?: FieldsSelection<Language, R>[]
    ) => Promise<FieldsSelection<Language, R>[]>;
  ...
  language: (args: {
    ...
    get: <R extends LanguageRequest>(
      request: R,
      defaultValue?: FieldsSelection<Language, R> | undefined
    ) => Promise<FieldsSelection<Language, R> | undefined>;
  };
}
...
export interface QueryObservableChain {
  _entities: (args: { representations: Scalars["_Any"][] }) => {
    get: <R extends _EntityRequest>(
      request: R,
      defaultValue?: (FieldsSelection<_Entity, R> | undefined)[]
    ) => Observable<(FieldsSelection<_Entity, R> | undefined)[]>;
  };
  _service: _ServiceObservableChain & {
    get: <R extends _ServiceRequest>(
      request: R,
      defaultValue?: FieldsSelection<_Service, R>
    ) => Observable<FieldsSelection<_Service, R>>;
  };
  countries: ((args?: { filter?: CountryFilterInput | null }) => {
    get: <R extends CountryRequest>(
      request: R,
  ...
  country: (args: {
    ...
    get: <R extends CountryRequest>(
      request: R,
      defaultValue?: FieldsSelection<Country, R> | undefined
    ) => Observable<FieldsSelection<Country, R> | undefined>;
  };
  continents: ((args?: { filter?: ContinentFilterInput | null }) => {
    get: <R extends ContinentRequest>(
      request: R,
  ...
  continent: (args: {
    ...
    get: <R extends ContinentRequest>(
      request: R,
      defaultValue?: FieldsSelection<Continent, R> | undefined
    ) => Observable<FieldsSelection<Continent, R> | undefined>;
  };
  languages: ((args?: { filter?: LanguageFilterInput | null }) => {
    get: <R extends LanguageRequest>(
      request: R,
  ...
  language: (args: {
    ...
    get: <R extends LanguageRequest>(
      request: R,
      defaultValue?: FieldsSelection<Language, R> | undefined
    ) => Observable<FieldsSelection<Language, R> | undefined>;
  };
}
