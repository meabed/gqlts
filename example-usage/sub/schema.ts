...
export interface mutation_rootRequest{
    ...
    where: option_bool_exp},option_mutation_responseRequest]
    /** delete single row from the table: "option" */
    delete_option_by_pk?: [{id: Scalars['uuid']},optionRequest]
    /** delete data from the table: "poll" */
    delete_poll?: [{
    /** filter the rows which have to be deleted */
    where: poll_bool_exp},poll_mutation_responseRequest]
    /** delete single row from the table: "poll" */
    ...
    delete_vote?: [{
    /** filter the rows which have to be deleted */
    where: vote_bool_exp},vote_mutation_responseRequest]
    /** delete single row from the table: "vote" */
    ...
    /** upsert condition */
    on_conflict?: (option_on_conflict | null)},option_mutation_responseRequest]
    /** insert a single row into the table: "option" */
    insert_option_one?: [{
    /** the row to be inserted */
    object: option_insert_input,
    /** upsert condition */
    on_conflict?: (option_on_conflict | null)},optionRequest]
    /** insert data into the table: "poll" */
    insert_poll?: [{
    /** the rows to be inserted */
    objects: poll_insert_input[],
    /** upsert condition */
    on_conflict?: (poll_on_conflict | null)},poll_mutation_responseRequest]
    /** insert a single row into the table: "poll" */
    insert_poll_one?: [{
    /** the row to be inserted */
    object: poll_insert_input,
    /** upsert condition */
    on_conflict?: (poll_on_conflict | null)},pollRequest]
    /** insert data into the table: "user" */
    insert_user?: [{
    /** the rows to be inserted */
    ...
    /** upsert condition */
    on_conflict?: (vote_on_conflict | null)},vote_mutation_responseRequest]
    /** insert a single row into the table: "vote" */
    insert_vote_one?: [{
    /** the row to be inserted */
    object: vote_insert_input,
    /** upsert condition */
    on_conflict?: (vote_on_conflict | null)},voteRequest]
    /** update data of the table: "option" */
    update_option?: [{
    ...
    update_option_by_pk?: [{
    /** sets the columns of the filtered rows to the given values */
    _set?: (option_set_input | null),pk_columns: option_pk_columns_input},optionRequest]
    /** update multiples rows of table: "option" */
    update_option_many?: [{
    /** updates to execute, in order */
    updates: option_updates[]},option_mutation_responseRequest]
    /** update data of the table: "poll" */
    update_poll?: [{
    /** sets the columns of the filtered rows to the given values */
    ...
    update_poll_by_pk?: [{
    /** sets the columns of the filtered rows to the given values */
    _set?: (poll_set_input | null),pk_columns: poll_pk_columns_input},pollRequest]
    /** update multiples rows of table: "poll" */
    update_poll_many?: [{
    /** updates to execute, in order */
    updates: poll_updates[]},poll_mutation_responseRequest]
    /** update data of the table: "user" */
    update_user?: [{
    /** sets the columns of the filtered rows to the given values */
    ...
    update_vote_by_pk?: [{
    /** sets the columns of the filtered rows to the given values */
    _set?: (vote_set_input | null),pk_columns: vote_pk_columns_input},voteRequest]
    /** update multiples rows of table: "vote" */
    update_vote_many?: [{
    /** updates to execute, in order */
    updates: vote_updates[]},vote_mutation_responseRequest]
...
export interface online_users_bool_exp {_and?: (online_users_bool_exp[] | null),_not?: (online_users_bool_exp | null),_or?: (online_users_bool_exp[] | null),count?: (bigint_comparison_exp | null)}
...
export interface online_users_order_by {count?: (order_by | null)}
...
export interface online_users_stream_cursor_value_input {count?: (Scalars['bigint'] | null)}
...
export interface option_aggregate_bool_exp {count?: (option_aggregate_bool_exp_count | null)}

export interface option_aggregate_bool_exp_count {arguments?: (option_select_column[] | null),distinct?: (Scalars['Boolean'] | null),filter?: (option_bool_exp | null),predicate: Int_comparison_exp}
...
export interface option_aggregate_order_by {count?: (order_by | null),max?: (option_max_order_by | null),min?: (option_min_order_by | null)}


/** input type for inserting array relation for remote table "option" */
export interface option_arr_rel_insert_input {data: option_insert_input[],
/** upsert condition */
...
export interface option_bool_exp {_and?: (option_bool_exp[] | null),_not?: (option_bool_exp | null),_or?: (option_bool_exp[] | null),id?: (uuid_comparison_exp | null),poll?: (poll_bool_exp | null),poll_id?: (uuid_comparison_exp | null),text?: (String_comparison_exp | null)}


/** input type for inserting data into table "option" */
export interface option_insert_input {id?: (Scalars['uuid'] | null),poll?: (poll_obj_rel_insert_input | null),poll_id?: (Scalars['uuid'] | null),text?: (Scalars['String'] | null)}
...
export interface option_max_order_by {id?: (order_by | null),poll_id?: (order_by | null),text?: (order_by | null)}
...
export interface option_min_order_by {id?: (order_by | null),poll_id?: (order_by | null),text?: (order_by | null)}
...
export interface option_obj_rel_insert_input {data: option_insert_input,
/** upsert condition */
on_conflict?: (option_on_conflict | null)}


/** on_conflict condition type for table "option" */
export interface option_on_conflict {constraint: option_constraint,update_columns: option_update_column[],where?: (option_bool_exp | null)}


/** Ordering options when selecting data from "option". */
export interface option_order_by {id?: (order_by | null),poll?: (poll_order_by | null),poll_id?: (order_by | null),text?: (order_by | null)}


/** primary key columns input for table: option */
export interface option_pk_columns_input {id: Scalars['uuid']}


/** input type for updating data in table "option" */
export interface option_set_input {id?: (Scalars['uuid'] | null),poll_id?: (Scalars['uuid'] | null),text?: (Scalars['String'] | null)}
...
/** Initial value of the column from where the streaming should start */
export interface option_stream_cursor_value_input {id?: (Scalars['uuid'] | null),poll_id?: (Scalars['uuid'] | null),text?: (Scalars['String'] | null)}
...
export interface pollRequest{
    ...
    where?: (option_bool_exp | null)},optionRequest] | optionRequest
    /** An aggregate relationship */
    options_aggregate?: [{
    /** distinct select on columns */
    distinct_on?: (option_select_column[] | null),
    ...
    order_by?: (option_order_by[] | null),
    /** filter the rows returned */
    where?: (option_bool_exp | null)},option_aggregateRequest] | option_aggregateRequest
...
export interface poll_bool_exp {_and?: (poll_bool_exp[] | null),_not?: (poll_bool_exp | null),_or?: (poll_bool_exp[] | null),created_at?: (timestamptz_comparison_exp | null),created_by?: (uuid_comparison_exp | null),id?: (uuid_comparison_exp | null),options?: (option_bool_exp | null),options_aggregate?: (option_aggregate_bool_exp | null),question?: (String_comparison_exp | null)}


/** input type for inserting data into table "poll" */
export interface poll_insert_input {created_at?: (Scalars['timestamptz'] | null),created_by?: (Scalars['uuid'] | null),id?: (Scalars['uuid'] | null),options?: (option_arr_rel_insert_input | null),question?: (Scalars['String'] | null)}
...
export interface poll_obj_rel_insert_input {data: poll_insert_input,
/** upsert condition */
on_conflict?: (poll_on_conflict | null)}


/** on_conflict condition type for table "poll" */
export interface poll_on_conflict {constraint: poll_constraint,update_columns: poll_update_column[],where?: (poll_bool_exp | null)}


/** Ordering options when selecting data from "poll". */
export interface poll_order_by {created_at?: (order_by | null),created_by?: (order_by | null),id?: (order_by | null),options_aggregate?: (option_aggregate_order_by | null),question?: (order_by | null)}


/** primary key columns input for table: poll */
export interface poll_pk_columns_input {id: Scalars['uuid']}
...
export interface poll_results_bool_exp {_and?: (poll_results_bool_exp[] | null),_not?: (poll_results_bool_exp | null),_or?: (poll_results_bool_exp[] | null),option?: (option_bool_exp | null),option_id?: (uuid_comparison_exp | null),poll?: (poll_bool_exp | null),poll_id?: (uuid_comparison_exp | null),votes?: (bigint_comparison_exp | null)}
...
export interface poll_results_order_by {option?: (option_order_by | null),option_id?: (order_by | null),poll?: (poll_order_by | null),poll_id?: (order_by | null),votes?: (order_by | null)}
...
/** Initial value of the column from where the streaming should start */
export interface poll_results_stream_cursor_value_input {option_id?: (Scalars['uuid'] | null),poll_id?: (Scalars['uuid'] | null),votes?: (Scalars['bigint'] | null)}
...
export interface poll_set_input {created_at?: (Scalars['timestamptz'] | null),created_by?: (Scalars['uuid'] | null),id?: (Scalars['uuid'] | null),question?: (Scalars['String'] | null)}
...
/** Initial value of the column from where the streaming should start */
export interface poll_stream_cursor_value_input {created_at?: (Scalars['timestamptz'] | null),created_by?: (Scalars['uuid'] | null),id?: (Scalars['uuid'] | null),question?: (Scalars['String'] | null)}
...
export interface query_rootRequest{
    ...
    /** filter the rows returned */
    where?: (online_users_bool_exp | null)},online_usersRequest] | online_usersRequest
    /** fetch aggregated fields from the table: "online_users" */
    ...
    order_by?: (online_users_order_by[] | null),
    /** filter the rows returned */
    where?: (online_users_bool_exp | null)},online_users_aggregateRequest] | online_users_aggregateRequest
    /** fetch data from the table: "option" */
    option?: [{
    /** distinct select on columns */
    distinct_on?: (option_select_column[] | null),
    ...
    /** filter the rows returned */
    where?: (poll_bool_exp | null)},pollRequest] | pollRequest
    /** fetch aggregated fields from the table: "poll" */
    poll_aggregate?: [{
    /** distinct select on columns */
    distinct_on?: (poll_select_column[] | null),
    ...
    order_by?: (poll_order_by[] | null),
    /** filter the rows returned */
    where?: (poll_bool_exp | null)},poll_aggregateRequest] | poll_aggregateRequest
    /** fetch data from the table: "poll" using primary key columns */
    ...
    /** filter the rows returned */
    where?: (poll_results_bool_exp | null)},poll_resultsRequest] | poll_resultsRequest
    /** fetch aggregated fields from the table: "poll_results" */
    ...
    order_by?: (poll_results_order_by[] | null),
    /** filter the rows returned */
    where?: (poll_results_bool_exp | null)},poll_results_aggregateRequest] | poll_results_aggregateRequest
    /** fetch data from the table: "user" */
    user?: [{
    /** distinct select on columns */
    ...
    /** filter the rows returned */
    where?: (vote_bool_exp | null)},voteRequest] | voteRequest
    /** fetch aggregated fields from the table: "vote" */
    vote_aggregate?: [{
    /** distinct select on columns */
    distinct_on?: (vote_select_column[] | null),
    ...
    order_by?: (vote_order_by[] | null),
    /** filter the rows returned */
    where?: (vote_bool_exp | null)},vote_aggregateRequest] | vote_aggregateRequest
    /** fetch data from the table: "vote" using primary key columns */
...
export interface subscription_rootRequest{
    ...
    /** filter the rows returned */
    where?: (online_users_bool_exp | null)},online_usersRequest]
    /** fetch data from the table: "option" */
    option?: [{
    /** distinct select on columns */
    distinct_on?: (option_select_column[] | null),
    ...
    /** filter the rows returned */
    where?: (option_bool_exp | null)},optionRequest]
    /** fetch data from the table: "poll" */
    poll?: [{
    /** distinct select on columns */
    distinct_on?: (poll_select_column[] | null),
    ...
    /** filter the rows returned */
    where?: (poll_results_bool_exp | null)},poll_resultsRequest]
    /** fetch data from the table in a streaming manner: "poll" */
    poll_stream?: [{
    /** maximum number of rows returned in a single batch */
    batch_size: Scalars['Int'],
    ...
    /** filter the rows returned */
    where?: (poll_bool_exp | null)},pollRequest]
    /** fetch data from the table: "user" */
    user?: [{
    /** distinct select on columns */
    distinct_on?: (user_select_column[] | null),
    ...
    /** filter the rows returned */
    where?: (vote_bool_exp | null)},voteRequest]
    __typename?: boolean | number
    __scalar?: boolean | number
}
...
export interface user_bool_exp {_and?: (user_bool_exp[] | null),_not?: (user_bool_exp | null),_or?: (user_bool_exp[] | null),created_at?: (timestamptz_comparison_exp | null),id?: (uuid_comparison_exp | null),last_seen_at?: (timestamptz_comparison_exp | null),online_ping?: (Boolean_comparison_exp | null)}


/** input type for inserting data into table "user" */
export interface user_insert_input {created_at?: (Scalars['timestamptz'] | null),id?: (Scalars['uuid'] | null),last_seen_at?: (Scalars['timestamptz'] | null),online_ping?: (Scalars['Boolean'] | null)}
...
export interface user_order_by {created_at?: (order_by | null),id?: (order_by | null),last_seen_at?: (order_by | null),online_ping?: (order_by | null)}
...
export interface user_set_input {created_at?: (Scalars['timestamptz'] | null),id?: (Scalars['uuid'] | null),last_seen_at?: (Scalars['timestamptz'] | null),online_ping?: (Scalars['Boolean'] | null)}
...
/** Initial value of the column from where the streaming should start */
export interface user_stream_cursor_value_input {created_at?: (Scalars['timestamptz'] | null),id?: (Scalars['uuid'] | null),last_seen_at?: (Scalars['timestamptz'] | null),online_ping?: (Scalars['Boolean'] | null)}
...
export interface vote_bool_exp {_and?: (vote_bool_exp[] | null),_not?: (vote_bool_exp | null),_or?: (vote_bool_exp[] | null),created_at?: (timestamptz_comparison_exp | null),created_by_user?: (user_bool_exp | null),created_by_user_id?: (uuid_comparison_exp | null),id?: (uuid_comparison_exp | null),option?: (option_bool_exp | null),option_id?: (uuid_comparison_exp | null)}


/** input type for inserting data into table "vote" */
export interface vote_insert_input {created_at?: (Scalars['timestamptz'] | null),created_by_user?: (user_obj_rel_insert_input | null),created_by_user_id?: (Scalars['uuid'] | null),id?: (Scalars['uuid'] | null),option?: (option_obj_rel_insert_input | null),option_id?: (Scalars['uuid'] | null)}
...
export interface vote_on_conflict {constraint: vote_constraint,update_columns: vote_update_column[],where?: (vote_bool_exp | null)}


/** Ordering options when selecting data from "vote". */
export interface vote_order_by {created_at?: (order_by | null),created_by_user?: (user_order_by | null),created_by_user_id?: (order_by | null),id?: (order_by | null),option?: (option_order_by | null),option_id?: (order_by | null)}


/** primary key columns input for table: vote */
export interface vote_pk_columns_input {id: Scalars['uuid']}


/** input type for updating data in table "vote" */
export interface vote_set_input {created_at?: (Scalars['timestamptz'] | null),created_by_user_id?: (Scalars['uuid'] | null),id?: (Scalars['uuid'] | null),option_id?: (Scalars['uuid'] | null)}
...
/** Initial value of the column from where the streaming should start */
export interface vote_stream_cursor_value_input {created_at?: (Scalars['timestamptz'] | null),created_by_user_id?: (Scalars['uuid'] | null),id?: (Scalars['uuid'] | null),option_id?: (Scalars['uuid'] | null)}
...
export const isonline_users_aggregate_fields = (obj?: { __typename?: any } | null): obj is online_users_aggregate_fields => {
...
export const isonline_users_stddev_pop_fields = (obj?: { __typename?: any } | null): obj is online_users_stddev_pop_fields => {
...
export const isonline_users_stddev_samp_fields = (obj?: { __typename?: any } | null): obj is online_users_stddev_samp_fields => {
...
export const isonline_users_var_pop_fields = (obj?: { __typename?: any } | null): obj is online_users_var_pop_fields => {
...
export const isonline_users_var_samp_fields = (obj?: { __typename?: any } | null): obj is online_users_var_samp_fields => {
...
export const isonline_users_variance_fields = (obj?: { __typename?: any } | null): obj is online_users_variance_fields => {
...
export const ispoll_results_aggregate_fields = (obj?: { __typename?: any } | null): obj is poll_results_aggregate_fields => {
...
export const ispoll_results_stddev_pop_fields = (obj?: { __typename?: any } | null): obj is poll_results_stddev_pop_fields => {
...
export const ispoll_results_stddev_samp_fields = (obj?: { __typename?: any } | null): obj is poll_results_stddev_samp_fields => {
...
export const ispoll_results_var_pop_fields = (obj?: { __typename?: any } | null): obj is poll_results_var_pop_fields => {
...
export const ispoll_results_var_samp_fields = (obj?: { __typename?: any } | null): obj is poll_results_var_samp_fields => {
...
export const ispoll_results_variance_fields = (obj?: { __typename?: any } | null): obj is poll_results_variance_fields => {
