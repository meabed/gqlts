...
const Page = (props: Props) => (
  <Stack flex="1" width="100%" minH="100%" h="100%" align="stretch" spacing="40px">
    <Box>
      <Stack spacing="40px">
        <SectionTitle
          // opacity={0.8}
    ...
    <Stack spacing="40px" flex="1" w="100%" h="100%" pb="60px" minH="100%" bg="gray.50">
      <Box h="140px" />
      <PackagesTable packages={props.packages} />
    </Stack>
    <Banner
      dark
      heading="Read Genqlx documentation"
      bullet="LEARN MORE"
      bg="transparent"
          ...
          >
            ...
            <Box flex="1">
              <Box isTruncated maxWidth="300px">
                <Link color="gray.500" href={p.graphql_endpoint} isExternal fontSize="inherit">
                  {p.graphql_endpoint}
                </Link>
              </Box>
            </Box>
