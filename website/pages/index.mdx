...
To use genqlx you first need to generate a sdk client for your graphql api.

Genqlx comes with built-in axios client and typed graphql query builder, file upload, subscription, batching, and more.
