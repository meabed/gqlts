...
Sometimes you will want to declare the field types separately or use the result type of a query in another function, this can be sone in genqlx importing some additional types
