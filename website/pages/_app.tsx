...
import { BG, DOCS_LINK, FIREBASE_ID_TOKEN_COOKIE, firebaseConfig, GITHUB_LINK } from "../constants";
...
export default function App(props) {
      ...
      <>
        ...
        <DokzProvider
          headerItems={[
            ...
            <Link isExternal href="https://github.com/meabed/genqlx">
              Github
            </Link>,
            <ColorModeSwitch />,
          ]}
  ...
  return (
    ...
    >
      <Head>
        <title>Genqlx - SDK client for any GraphQL API</title>
      </Head>
      <LandingProvider minH="100%" h="100%" background={BG} black="#333" primary="#48BB79" color="#444">
        <MyNavbar />
...
export function MyFooter({ ...rest }) {
  return (
    <Footer
      businessName="Genqlx"
      columns={{
        Resources: [<MyLink href={GITHUB_LINK}>Github</MyLink>, <MyLink href={DOCS_LINK}>Docs</MyLink>],
        "Find Us": [
          <MyLink href="https://twitter.com/__morse">Twitter</MyLink>,
          <MyLink href="https://github.com/meabed/">Github</MyLink>,
        ],
        "Who made this?": [
          <MyLink href="https://twitter.com/meabed">My Twitter</MyLink>,
          <MyLink href="https://github.com/meabed/">My Github</MyLink>,
        ],
        "Proudly sponsored by Vercel": [<Box as={PoweredByVercel} alignSelf="center" />],
      }}
      {...rest}
    />
  );
...
export const PoweredByVercel = ({ ...rest }) => {
  return (
    <a href="https://vercel.com?utm_source=genqlx" target="_blank" {...rest}>
...
export function MyLink({ isExternal = false, href = "#", ...rest }) {
  ...
  return (
    <NextLink prefetch={isExternal} shallow={isExternal} href={href} passHref {...rest}>
      <Link
        fontWeight="medium"
        isExternal={isExternal}
        // color='black'
